...
<<<<<<< .mine
            scope.contentBtn = function(newsId,index){
                $rootScope.transfer(scope,newsId,index)
            };
            //日期转换
